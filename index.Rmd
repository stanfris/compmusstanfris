...
<!-- In this section we can see the self similarity matrices of the songs that  -->

<!-- column {width=1000 .tabset} -->
<!-- ------------------------------------- -->
<!-- ### Timbre Comparison -->
<!-- ``` {r self-similarity, fig.width=7, fig.height=7} -->
<!-- bmc_theme_sim <- -->
<!-- bmc_theme |> -->
...
<!-- plot_grid(bmc_theme_sim, btdb_theme_sim, btd5_theme_sim, btd6_theme_sim, ncol = 2) -->
<!-- ``` -->
