...
---------------------------------------------------------------------
### Description
  As discussed at the start, Bloons TD Battles 2 has a few songs that jump into different genres. This section will investigate the classification of the songs, and see if it is able to distinguish different genres.
...
halloween <-
  Battles_2 %>% distinct(track.name, .keep_all = TRUE) |>
  add_audio_analysis() |>
  mutate(
