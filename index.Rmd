...
---------------------------------------------------------------------
### Description
In this section we will use a classification model to see if we can predict which game a song is from based on its features. We will use the tempo, valence, energy, and danceability of the songs to predict the game.
...
halloween <-
  get_playlist_audio_features("bnfcollection", "2lpTXCxSbaSvTBgVrtbdqt") |>
  add_audio_analysis() |>
  mutate(
